...
(priority order), and the next Mon/Wed/Fri 09:00 ET slots to assign. With
...
def next_slots(manifest, now, n):
    """Next n Mon/Wed/Fri 09:00 slots after the later of now and the last scheduled post,
